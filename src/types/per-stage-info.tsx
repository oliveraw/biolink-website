...
export const perStageInfo = [
    ...
    {
        pipelineStage: PipelineStage.PSA1,
        name: "PSA",
    ...
    {
        pipelineStage: PipelineStage.PSA2,
        name: "Repeat PSA",
    ...
    {
        pipelineStage: PipelineStage.UROLOGIST,
        name: "Urologist",
    ...
    {
        pipelineStage: PipelineStage.BIOMARKER,
        name: "pstateDx",
    ...
    {
        pipelineStage: PipelineStage.BIOPSY,
        name: "Biopsy",
    ...
    {
        pipelineStage: PipelineStage.REPEAT_PSA,
